...
const Banner = ({ updatedBanner }) => {
  ...
  return (
    <div className=" h-[40vh]  w-[98vw] mx-auto relative">
      <img className='md:h-[93.3vh] h-[40vh] w-[98vw] mx-auto' src={updatedBanner?.name ? updatedBanner?.img : 'https://occ-0-2482-2186.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABcaZlB5cBXaQovKzRNe3DLOD5xe5ug2Msp7y4SHAFXs8Uu-s9esOCD1X3jnbYZZ4Dm-tM-cOgWh1FDmFD0wIfIfbrkpJAoULvXWX.jpg?r=c9b%22'} alt="" />
      <div className='absolute md:pt-[10%] p-5 md:pl-20 md:top-[0%] top-[0%] md:h-[93.3vh] h-[40vh] text-white  bg-gradient-to-r from-black'>
