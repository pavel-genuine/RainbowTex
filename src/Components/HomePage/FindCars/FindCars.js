    ...
    return (
        <div
            ...
            <form className="flex  justify-center items-center flex-col relative" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='flex mt-16  justify-center items-center flex-col space-y-4 w-[100%]'>
                ...
                <div className='my-4 relative form-control bg-white rounded flex boder justify-center items-center '>
