...
const UsersTable = () => {
    ...
    return (
        ...
        <p className='font-semibold my-10 bg-slate-600 px-3 md:w-[25%]  py-2 text-lg  '>Total Users : {`users.length`} </p>
            ...
            <table class="shadow-lg table-auto overflow-x-scroll overflow-auto w-full">
                ...
                <tbody className='bg-[#26282b]'>
                    <tr>
                        ...
                        <td class="border border-[#181818] px-8 py-4">Email1</td>
                        <td class="border border-[#181818] px-8 py-4">unpaid</td>
