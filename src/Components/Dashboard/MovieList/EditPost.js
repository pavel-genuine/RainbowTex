...
const EditPost = () => {
    ...
    return (
        <div className='text-slate-200 p-5  '>
            <Toaster></Toaster>
            <div className='mx-auto mx-auto  md:grid grid-cols-12 '>
                <div className='col-span-12  pb-10 mx-auto  '>

                    <form onSubmit={handleSubmit(onSubmit)}>
                        <h2 className="text-2xl font-bold text-slate-800">Update Information</h2>
                                    ...
                                    >
                                        {({
                                            ...
                                            <div className="upload__image-wrapper relative text-black">
                                                ...
                                                <div class="mt-1 flex justify-center mb-8 mr-2 items-center px-6 pt-5 pb-6 border-2 md:w-[14vw] w-[20vw] h-[80px] md:h-[150px]  border-dashed rounded-md">
                            ...
                            <div className='text-slate-800'>
                                <div className='grow-wrap'>
                                    <textarea
                                        ...
                                        className='shadow-sm border-b-2  text-2xl font-blod focus:outline-none mt-8  mt-1 block w-full sm:text-md p-2'
                                ...
                                <div className='flex '>
                                    <div className='grow-wrap'>
                                        <textarea
                                            ...
                                            className='shadow-sm border-b-2 md:text-lg font-blod focus:outline-none mt-20 px-2 mt-1 block w-full sm:text-md p-2'
                                            name="" id="" cols="30" rows="2"
                                            {...register("release")}>
                                        </textarea>
                                    </div>
                                    ...
                                    <div className='grow-wrap'>
                                        <textarea
                                            ...
                                            className='shadow-sm border-b-2 md:text-lg font-blod focus:outline-none mt-20 px-2 block w-full sm:text-md p-2'
                                            name="" id="" cols="30"
                                            {...register("rating")}>
                                        </textarea>
                                    </div>
                                ...
                                <div className='grow-wrap'>
                                    <textarea
                                        ...
                                        className=" shadow-sm border-b-2 focus:outline-none mt-20 pt-12 text-lg mt-1 block w-full  px-2 "
