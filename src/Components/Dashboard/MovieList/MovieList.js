...
const MovieList = () => {
    ...
    const handleDeleteOne = (id) => {
        ...
        if (confirmation) {
            ...
            const newMovies=data?.filter(item => item?._id != id)
            setMovies(()=>newMovies)
        }
    }
                    ...
                    <div class="space-y-4 ">
                        ...
                        <div className=''>
                            <div className="px-5 md:px-0">
                                ...
                                <p className='font-semibold my-5 bg-slate-600 px-3 py-2 md:mr-20 text-lg md:w-96 rounded-lg'>Total Movies Uploaded : {movies?.length? movies?.length:data?.length} </p>
