...
export const base_url = 'https://api.gotirentals.com/api';
...
export const carOwnerCarUpdate = (data, id) => axiosInstance.patch(`/carowner/car/${id}`, data);
export const carOwnerCarDelete = (id) => axiosInstance.delete(`/carowner/car/${id}`);
export const carOwnerAssignDriver = (data) => axiosInstance.patch(`/carowner/assign_driver`, data);
...
export const passengerFindCars = (params) => axios.get(`${base_url}/user/inquiry${params}`);
export const SingleCarDetail = (id) => axiosInstance.get(`/car/details/${id}`);
export const passengerBookingRequest = (data) => axiosInstance.post(`/user/booking_request`, data);
